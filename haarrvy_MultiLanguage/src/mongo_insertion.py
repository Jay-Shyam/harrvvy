...
MONGODB_URI = "mongodb+srv://jayashyam2004:7zU6Ne2DclRXsjBn@hackbyte.6dzdkbv.mongodb.net/?retryWrites=true&w=majority&appName=hackbyte"

# Initialize MongoDB client
try:
    client = MongoClient(MONGODB_URI)
    db = client["ehr_database"]  # Your database name
    collection = db["EHR"]  # Collection to store EHR data
